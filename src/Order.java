...
public class Order {
    ...
    public Order(ArrayList<Cupcake> cupcakeMenu,
                 ArrayList<Drink> drinkMenu) {
    ...
    public CreateFile() {
        try {
            ...
            if (salesData.createNewFile()) {
                System.out.println("File created: " + salesData);
            } else {

...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("We are deciding on the price for our fountain beverages. Here is the description: ");
        soda.type();
        System.out.println("How much would you like to charge for the fountain beverage? " +
                "(Input a numerical number taken to 2 decimal places.)");
        priceText = input.nextLine();
        price = Double.parseDouble(priceText);
        soda.setPrice(price);
    ...
    class Drink {
        ...
        class Soda extends Drink {
            public void type() {
                System.out.println("A fountain beverage.");
            }
        }

        class Milk extends Drink {
            public void type() {
                System.out.println("Perfect accompaniment to a cupcake.");
            }
        }
